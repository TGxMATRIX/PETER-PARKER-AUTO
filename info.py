...
# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 305))
...
WELCOM_PIC = environ.get("WELCOM_PIC", "https://graph.org/file/30574f7e4dfd2ef585b80.mp4")
...
IMDB_DELET_TIME = int(environ.get('IMDB_DELET_TIME', "998"))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MatRixBotzTGsupport')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "True")), True)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "{file}/n@MatRixBotzTG")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "{file}/n@MatRixBotzTG")
