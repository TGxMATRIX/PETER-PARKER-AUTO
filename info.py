...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "{file_name}</code> {file_size}</i> @MatRixBotzTG")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "{file_name}</code> {file_size}</i> @MatRixBotzTG" True)
