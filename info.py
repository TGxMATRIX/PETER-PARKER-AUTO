...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "FILE : <code>{file_name}</code> Size : <i>{file_size}</i> @MatRixBotzTG")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "FILE : <code>{file_name}</code> Size : <i>{file_size}</i> @MatRixBotzTG" True)
